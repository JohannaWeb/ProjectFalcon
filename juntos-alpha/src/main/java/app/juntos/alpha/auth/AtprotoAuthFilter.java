...
public class AtprotoAuthFilter extends OncePerRequestFilter {
    ...
    private ECPublicKey extractEcPublicKey(Map<String, Object> didDoc, String jwtCurve, String jcaCurve, String kid) throws Exception {
    ...
    @SuppressWarnings("unchecked")
    private ECPublicKey extractVmEcPublicKey(Map<String, Object> vm, String jwtCurve, String jcaCurve) throws Exception {
        // JWK format
    ...
    private boolean kidMatches(String kid, String vmId, String did) {
        ...
        if (kid.startsWith("#")) return vmId.endsWith(kid);
        if (vmId.startsWith("#") && did != null) return kid.equals(did + vmId);
        return false;
    }
