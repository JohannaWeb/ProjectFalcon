...
I live in Portugal and build independently. My learning style is intense and iterative — long focused cycles followed by refinement.

Outside of software, I lift weights and play jazz guitar. Both influence how I build: repetition, structure, and incremental improvement.
...
- accounts instead of identities
...
- microservice-based backend (Gateway, Core, Trust, SIV)
- decentralized trust graph experimentation
- AT Protocol integration
- Java + Spring Boot services
- Electron + React client
- containerized deployment and observability stack

The focus was validating technical direction, not polishing features.

---

## Approach

I believe good systems come from:

- building before explaining
- testing ideas through architecture
