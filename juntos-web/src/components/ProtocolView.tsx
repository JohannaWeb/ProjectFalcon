  ...
  return (
    <div className="protocol-container">
      <header className="protocol-header">
        <h1>Juntos: An Adversarial Algorithmic Trust Protocol</h1>                <p className="author">Johanna Almeida | February 2026</p>
      ...
      <section className="abstract">
        <h2>Abstract</h2>
        <p>
          Juntos introduces an automated, zero-trust reputation framework designed for the AT Protocol ecosystem.
          By utilizing subjective transitive trust with temporal decay and non-linear squashing,
          Juntos establishes a mathematical standard for decentralized trust that is resistant to Sybil attacks and collusion.                </p>
      </section>
      ...
      <section className="links">
        <a href="/docs/Juntos_arXiv_Package.zip" className="download-btn" download>
