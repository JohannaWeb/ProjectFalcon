...
import app.falcon.alpha.domain.Message;
import app.falcon.alpha.repository.ChannelRepository;
import app.falcon.alpha.repository.MessageRepository;
...
public class ChannelController {
    ...
    @GetMapping("/app.falcon.channel.list")
    ...
    @PostMapping("/app.falcon.channel.create")
    ...
    @GetMapping("/app.falcon.channel.getMessages")
    ...
    @PostMapping("/app.falcon.channel.postMessage")
